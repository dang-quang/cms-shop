  ...
  function itemMenuDashBoard() {
      ...
      <GridItem xs={4} sm={4} md={4} key={index}>
        <Link href={item.route}>
          <div className={classes.itemMenu} onClick={handleClickItemMenu}>
            ...
            <p className={classes.itemMenuTxt}>
    ...
    return (
      <div className={classes.listItem}>
        ...
        {size.width <= 959 && (
          <MenuList role="menu">{listItemResponsive}</MenuList>
        )}
      </div>
    );
  }
    ...
    <div style={{ position: "relative", zIndex: 99 }}>
      ...
      <div className={classes.manager}>
        ...
        <Poppers
          ...
          disablePortal
          className={
            classNames({ [classes.popperClose]: !openAddNew }) +
            " " +
            classes.popperNav
          }
        >
                      ...
                      return (
                        <Link href={item.route} style={{ color: "white" }} key={index}>
                          <MenuItem
                            ...
                            className={
                              classes.dropdownItem + " " + classes.addList
                            }
                          >
                            <Icon className={classes.menuIcon2}>
                              {item.icon}
                            </Icon>
      ...
      <Poppers
        ...
        disablePortal
        className={
          classNames({ [classes.popperClose]: !openDashboardMenu }) +
          " " +
          classes.popperNav
        }
      >
