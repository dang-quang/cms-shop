        ...
        <div className={classes.flex_center} style={{ alignItems: "end" }}>
          ...
          >
            <Switch
              //checked={item.status}
              value={batchSetting.limit_value}
              onChange={handleChangeBatchSetting("limit_value", "bool")}
              name="checkedA"
            />
          ...
          <FormCellCustom label={text.form_cell_custom[1]} helperText={""}>
            <div className={classes.formCell + " " + classes.flex_center}>
              <RadioGroup
                ...
                onChange={handleChangeValue("time_type")}
...
AddFlashSalePage.layout = Admin;

export default WithAuthentication(AddFlashSalePage);
