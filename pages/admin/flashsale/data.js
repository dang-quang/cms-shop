      ...
      <TableRow key={'renderTable' + index} className={tableClasses.tableBodyRow}>
        ...
        <TableCell className={tableClasses.tableCell} key={'revenue'}>
          <p className={classes.text + ' ' + classes.infoTextPrimary}>
            {item.product.product_type.map((props) => {
              return (
                <p className={classes.text + ' ' + classes.infoTextPrimary}>{props.revenue}</p>
              );
            })}
          </p>
        </TableCell>
        ...
        <TableCell className={tableClasses.tableCell} key={'Products'}>
          <p className={classes.text + ' ' + classes.infoTextPrimary}>
            {item.product.product_type.map((props) => {
              return (
                <p className={classes.text + ' ' + classes.infoTextPrimary}>{props.products}</p>
              );
            })}
          </p>
        </TableCell>
        <TableCell className={tableClasses.tableCell} key={'Reminders'}>
          <p className={classes.text + ' ' + classes.infoTextPrimary}>
            {item.product.product_type.map((props) => {
              return (
                <p className={classes.text + ' ' + classes.infoTextPrimary}>{props.reminders}</p>
              );
            })}
          </p>
        </TableCell>
