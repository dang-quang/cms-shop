...
function CreateStockProductManual() {
  ...
  const handelCreateIventoryProduct = async () => {
    if (values.item_name.length > 0 && values.sku.length > 0 && values.stock.length > 0) {
      dispatch(setShowLoader(true));
      if (selectedFiles) {
          ...
          <GridContainer>
            <GridItem xs={12} sm={6} md={3}>
              <FormControl
                ...
                variant="outlined"
                size="small">
                <InputLabel htmlFor="outlined-adornment-amount-1">{text.form.value[9]}</InputLabel>
                <OutlinedInput
            ...
            <GridItem xs={12} sm={6} md={3}>
              <FormControl
                ...
                variant="outlined"
                size="small">
                <InputLabel htmlFor="outlined-adornment-amount-2">{text.form.value[10]}</InputLabel>
                <OutlinedInput
            ...
            <GridItem xs={12} sm={6} md={3}>
              <FormControl
                ...
                variant="outlined"
                size="small">
                <InputLabel htmlFor="outlined-adornment-amount-3">{text.form.value[11]}</InputLabel>
                <OutlinedInput
            ...
            <GridItem xs={12} sm={6} md={3}>
              <FormControl
                ...
                variant="outlined"
                size="small">
                <InputLabel htmlFor="outlined-adornment-amount-4">{text.form.value[12]}</InputLabel>
                <OutlinedInput
          ...
          <GridContainer>
            <GridItem xs={12} sm={4} md={2}>
              <FormControl
                ...
                variant="outlined"
                size="small">
                <InputLabel htmlFor="outlined-adornment-amount-5">{text.form.value[13]}</InputLabel>
                <OutlinedInput
            ...
            <GridItem xs={12} sm={4} md={2}>
              <FormControl
                ...
                variant="outlined"
                size="small">
                <InputLabel htmlFor="outlined-adornment-amount-6">{text.form.value[14]}</InputLabel>
                <OutlinedInput
            ...
            <GridItem xs={12} sm={4} md={2}>
              <FormControl
                ...
                variant="outlined"
                size="small">
                <InputLabel htmlFor="outlined-adornment-amount-7">{text.form.value[15]}</InputLabel>
                <OutlinedInput
            ...
            <GridItem xs={12} sm={4} md={2}>
              <FormControl
                ...
                variant="outlined"
                size="small">
                <InputLabel htmlFor="outlined-adornment-amount-8">{text.form.value[16]}</InputLabel>
                <OutlinedInput
            ...
            <GridItem xs={12} sm={8} md={4}>
              <FormControl
                ...
                variant="outlined"
                size="small">
                <InputLabel htmlFor="outlined-adornment-amount-9">{text.form.value[17]}</InputLabel>
                <OutlinedInput
