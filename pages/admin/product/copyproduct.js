      ...
      <div className={classes.proContainer}>
        ...
        <div className={classes.proInfoContainer}>
          ...
          <div className={classes.proContainer}>
            {item.has_model && (
              <div
                className={classes.shopInfoContainer + ' ' + classes.shopInfoMore}
                style={{ cursor: 'pointer' }}
                onClick={() => handleShowProduct(item)}>
                {showProduct.indexOf(item) !== -1 ? (
                  <Icon className={classes.codeIcon} style={{ color: primaryColor[0] }}>
                ...
                <p className={tableClasses.tableCell + ' ' + classes.txtMoreTypes}>
      ...
      <CardBody className={classes.cardBody}>
        <div
          ...
          <div style={{ display: 'flex' }}>
            {/* search */}
            <FormControl className={dashClasses.formControl + ' ' + classes.fullWidthFormControl}>
              <CustomInput
                formControlProps={{
                  className:
                    adminClasses.margin +
                    ' ' +
                    classes.customWidthSearch +
                    ' ' +
          ...
          <div className={classes.proContainer}>
            <GridContainer style={{ width: '100%' }}>
              ...
              <GridItem xs={2} sm={2} md={2}>
                <div className={classes.filterShopContainer + ' ' + classes.cutom4_span}>
