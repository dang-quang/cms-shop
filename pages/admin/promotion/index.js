...
import { getChannelData, getAllPromotionMarketing, updatePromotionMarketing, deletePromotionMarketing } from "../../../utilities/ApiManage";
  ...
  const listText = [
    {
      ...
      subTitle2:
        "Let's start creating Promotions for your own store",
                          ...
                          >
                            ...
                            >
                              <img
                                ...
                                src={shop.icon}
                              />
                              <span className={classes.shopApplied}>
                                {shop.code}
                              </span>
                            </div>
                          </Tooltip>
          ...
          <div className={classes.flex_center}>
            {item.list_products?.map((product, pIndex) => {
              if (pIndex <= 2) {
                ...
                pIndex > 2 &&
                pIndex == item.list_products.length - 1
              ) {
                return (
                  <>
                    <img src={product.image} className={classes.tableImage} key={pIndex}/>
