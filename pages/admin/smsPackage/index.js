...
import styles from "assets/jss/natcash/views/sms/smsIndexStyle";
            ...
            <CardFooter>
                ...
                >
                    <Table className={tableClasses.table}>
                        ...
                        <TableBody>
                            {SmsPackageFakeData.map((item, index) => {
...
SMSPackage.layout = Admin;

export default WithAuthentication(SMSPackage);
