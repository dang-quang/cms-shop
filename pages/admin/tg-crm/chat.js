  ...
  const renderFilterMess = () => {
          ...
          <div>
            {listTag.map((item, index) => (
              <div className={classes.flexCenter}>
                ...
                />
                <Button
                  style={{ backgroundColor: item.color, height: "23px" }}
                  size="sm"
                >
                  {item.name}
                </Button>
    ...
    const filterTime = () => (
      <div
        ...
        style={{ width: isMobile ? "190px" : "460px" }}
      >
        <div style={{ padding: "7px 15px", borderRadius: "4px" }}>
          <p
            style={{
      ...
      listOrder.map((item, index) => (
        <Card style={{ marginTop: "0", marginBottom: "20px" }}>
          <CardBody>
            ...
            >
              <p
                style={{ margin: 0, fontWeight: "500", color: successColor[0] }}
              >
                {item.order_status}
              </p>
        ...
        >
          ...
          >
            <CustomInput
              formControlProps={{
                className:
                  adminClasses.margin + " " + classes.searchInputContainer,
              }}
              inputProps={{
                ...
                <div className={classes.flexCenter} style={{ margin: "5px 0" }}>
                  ...
                  <div>
                    ...
                    <p style={{ margin: 0, color: "#a6a6a6" }}>
                      {text.txtMinValue +
                        ": " +
                        formatCurrency(item.min_basket_price)}
                    </p>
                  </div>
                </div>
                <div
      ...
      <div>
        ...
        >
          {item.message_type != "order" &&
            ...
            type != "SHOP" && (
              <img
                src={
                  selectedMess.to_avatar ? selectedMess.to_avatar : customerAva
                }
          ...
          <div style={{ maxWidth: "75%" }}>
            {item.message_type == "text" && (
              <p
                className={
                  type == "SHOP" ? classes.txtMessChatShop : classes.txtMessChat
                }
              >
                {item.content.text}
              </p>
            ...
            {item.message_type == "image" && (
              <img
                ...
                onClick={() => setShowImage(item.content.url)}
              ></img>
            )}
        ...
        {item.message_type == "order" && (
          <div className={classes.messOrderContainer}>
            ...
            <div>
              <p style={{ margin: 0 }}>
                {text.txtOrderId + " " + item.content.order_sn}
              </p>
              <div className={classes.flexCenter}>
                <p style={{ margin: 0, marginRight: "5px" }}>
                  {text.txtTotalPayment + ": "}
                </p>
                <p style={{ margin: 0, color: primaryColor[0] }}>
              ...
              <p
                style={{ margin: 0, color: successColor[0], fontWeight: "500" }}
              >
        ...
        >
          ...
          >
            <div className={classes.flexCenter}>
              <img
                src={
                  selectedMess.to_avatar
                    ? selectedMess.to_avatar
                    : customerAvaWhite
                }
                className={classes.imageCustomerAva}
              ></img>
              <div>
                <h4 className={classes.cardTitleWhite}>
                  {selectedMess.to_name}
                </h4>
                <div className={classes.flexCenter}>
            ...
            <div style={{ marginTop: isMobile ? "10px" : "0" }}>
              ...
              >
                ...
                <p
                  style={{ margin: "0", marginLeft: "10px", fontSize: "15px" }}
                >
          ...
          >
            <div
              style={{ padding: isMobile ? "1.9375rem 0" : "1.9375rem 20px" }}
            >
              {messData.map((item, index) => {
                return item.from_id
                  ? renderMess(item, "CUSTOMER")
                  : renderMess(item, "SHOP");
              })}
            </div>
          </div>
          <div className={classes.bottomMessContainer}>
            ...
            <div
              className={classes.flexCenter}
              style={{ padding: "10px 20px", overflowY: "auto" }}
            >
              <LocalOfferOutlined
                style={{ marginRight: "10px", color: grayColor[0] }}
              ></LocalOfferOutlined>
              {listTag.map((item, index) => (
                <Button
                  style={{
            ...
            >
              ...
              >
                <CustomInputChat
                  className={classes.txtMessage}
                  placeholder={text.txtMessPlaceholder}
                ></CustomInputChat>
                <Button
                  justIcon
                  color="primary"
          ...
          >
            <Fade in={showImage != null}>
              <img
                src={showImage}
                style={{ maxWidth: "80%", minWidth: "350px", height: "auto" }}
              ></img>
            </Fade>
          </Modal>
        </Card>
                ...
                <div className={classes.flexCenter}>
                  {selectedUtilTab.subTabs.map((item, index) => (
                    <div
                      style={{
                        width:
                          selectedUtilTab.subTabs.length == 2 ? "50%" : "auto",
                      }}
                    >
                      <Button
                        color="transparent"
    ...
    <div style={{ display: isMobile ? "block" : "flex" }}>
      ...
      >
        ...
        <CardBody className={classes.cardMess}>
          <FormControl
            className={dashClasses.formControl + " " + classes.frmMessage}
          >
              ...
              {MESS_FILTER.map((item, index) => (
                ...
                >
                  <Button
                    color="transparent"
                    aria-owns={
                      filterMess == item ? "filter-list-grow" + item?.id : null
                    }
                    aria-haspopup="true"
                  ...
                  >
                    ...
                    {item.isMore && (
                      <Icon className={classes.filterMore}>
                    ...
                    >
                      {({ TransitionProps, placement }) => (
                        ...
                        >
                          <Paper>
                            <ClickAwayListener
                              onClickAway={() => setFilterMess(null)}
                            >
                              {renderFilterMess()}
                            </ClickAwayListener>
                          </Paper>
        ...
        <div
          className={classes.messContainer}
            ...
            return (
              ...
              >
                <div style={{ position: "relative" }}>
                  ...
                  ></img>
                  {item.unread_count > 0 && (
                    <p className={classes.txtUnreadCount}>
                      {item.unread_count}
                    </p>
                  )}
                </div>
                <div className={classes.messNameTimeContainer}>
                  <div className={classes.messNameContainer}>
                    ...
                    {item.latest_message_type == "product" && (
                      <p className={classes.txtLastMess}>
                        {text.lastMessType[0]}
                      </p>
                    )}
