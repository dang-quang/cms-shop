...
function UserProfile() {
  ...
  const handelChangePassword = async () => {
    ...
    if (res.success == true) {
      ...
      // setTimeout(function(){ Router.push("/admin/login"); }, 3000);
    } else {
  ...
  const handleBlurConfirmPassword = () => {
    ...
    if (new_password === confirm_password && confirm_password.length > 0) {
      ...
      setHelperTextConfirmPassword(
        "Confirm password does not match the New password or null"
      );
    }
  };
      ...
      <GridContainer>
        ...
        <GridItem xs={12} sm={12} md={4}>
          <Card profile>
            ...
            <CardBody profile>
              <h6 className={classes.cardCategory + " " + classes.text}>
                {user.name}
              </h6>
              <h4 className={classes.cardTitle + " " + classes.text}>
                {user.email}
              </h4>
