...
interface TableFinishedProps {}

export const TableFinished: React.FC<TableFinishedProps> = () => {
  ...
  React.useEffect(() => {
    (async () => {
      try {
        ...
        const res = await requestGetListVoucher({ page: 1, type: EVoucherStatus.FINISHED });
